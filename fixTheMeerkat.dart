// Code Challenge: https://www.codewars.com/kata/56f699cd9400f5b7d8000b55/train/dart
...
// body, head). It is your job to re-arrange the array so that the animal is the right way round (head, body, tail).
